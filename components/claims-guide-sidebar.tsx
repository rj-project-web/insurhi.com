...
import type { ClaimsGuideSection } from "@/lib/claims-guide-utils";

type ClaimsGuideSidebarProps = {
  sections: ClaimsGuideSection[];
  categorySlug?: string | null;
  categoryTitle?: string | null;
};

export function ClaimsGuideSidebar({
  sections,
  categorySlug,
  categoryTitle,
}: ClaimsGuideSidebarProps) {
  return (
